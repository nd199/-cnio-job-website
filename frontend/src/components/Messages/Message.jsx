    ...
    <div className="w-full h-[110px] flex justify-between items-center px-2">
      ...
      >
        ...
        <p className="text-sm line-clamp-2 xs:line-clamp-3 sm:line-clamp-3">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis corrupti ipsa harum quas,
          commodi minima voluptatem cupiditate exercitationem architecto dolore veniam velit
          reiciendis quae, ducimus autem repellendus quasi tempora illum!
        </p>
      </div>
    </div>
  );
